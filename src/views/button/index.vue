  ...
  <section class="app-container">
    <el-card class="box-card">
      ...
      <a-modal title="添加图标" @ok="handleOk" @click="allotIcon" v-model="dialogFormVisibleIcon">
        ...
        <li class><i @click='onsomething' class="anticon anticon-bars"></i></li>
        <li class><i @click='onsomething' class="anticon anticon-copy"></i></li>
        <li class><i @click='onsomething' class="anticon anticon-lock"></i></li>
        <li class><i @click='onsomething' class="anticon anticon-unlock"></i></li>
        <li class><i @click='onsomething' class="anticon anticon-bars"></i></li>
        <li class><i @click='onsomething' class="anticon anticon-book"></i></li>
        <li class><i @click='onsomething' class="anticon anticon-calendar"></i></li>
        <li class><i @click='onsomething' class="anticon anticon-cloud"></i></li>
        <li class><i @click='onsomething' class="anticon anticon-cloud-download"></i></li>
        <li class><i @click='onsomething' class="anticon anticon-code"></i></li>
        <li class><i @click='onsomething' class="anticon anticon-credit-card"></i></li>
        <li class><i @click='onsomething' class="anticon anticon-download"></i></li>
        </ul>-->
        <ul class="anticons-list">
          <li class>
            <i @click="onsomething" class="anticon anticon-lock">
              <svg
            ...
            <span class="anticon-class">
              <span class="ant-badge">lock
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-unlock">
              <svg
                viewBox="64 64 896 896"
                data-icon="unlock"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">unlock
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-bars">
              <svg
            ...
            <span class="anticon-class">
              <span class="ant-badge">bars
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-book">
              <svg
                viewBox="64 64 896 896"
                data-icon="book"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">book
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-calendar">
              <svg
                viewBox="64 64 896 896"
                data-icon="calendar"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">calendar
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-cloud">
              <svg
                viewBox="64 64 896 896"
                data-icon="cloud"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">cloud
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-cloud-download">
              <svg
                viewBox="64 64 896 896"
            ...
            <span class="anticon-class">
              <span class="ant-badge">cloud-download
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-code">
              <svg
                viewBox="64 64 896 896"
                data-icon="code"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">code
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-copy">
              <svg
                viewBox="64 64 896 896"
                data-icon="copy"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">copy
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-credit-card">
              <svg
                viewBox="64 64 896 896"
            ...
            <span class="anticon-class">
              <span class="ant-badge">credit-card
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-delete">
              <svg
                viewBox="64 64 896 896"
                data-icon="delete"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">delete
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-desktop">
              <svg
                viewBox="64 64 896 896"
                data-icon="desktop"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">desktop
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-download">
              <svg
                viewBox="64 64 896 896"
                data-icon="download"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">download
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-ellipsis">
              <svg
                viewBox="64 64 896 896"
                data-icon="ellipsis"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">ellipsis
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-file">
              <svg
                viewBox="64 64 896 896"
                data-icon="file"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">file
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-file-text">
              <svg
                viewBox="64 64 896 896"
                data-icon="file-text"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">file-text
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-file-unknown">
              <svg
                viewBox="64 64 896 896"
            ...
            <span class="anticon-class">
              <span class="ant-badge">file-unknown
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-file-pdf">
              <svg
                viewBox="64 64 896 896"
                data-icon="file-pdf"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">file-pdf
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-file-word">
              <svg
                viewBox="64 64 896 896"
                data-icon="file-word"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-file-excel">
              <svg
                viewBox="64 64 896 896"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-file-jpg">
              <svg
                viewBox="0 0 1024 1024"
                data-icon="file-jpg"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">file-jpg
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-file-ppt">
              <svg
                viewBox="64 64 896 896"
                data-icon="file-ppt"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">file-ppt
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-file-markdown">
              <svg
                viewBox="64 64 896 896"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-file-add">
              <svg
                viewBox="64 64 896 896"
                data-icon="file-add"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">file-add
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-folder">
              <svg
                viewBox="64 64 896 896"
                data-icon="folder"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">folder
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-folder-open">
              <svg
                viewBox="64 64 896 896"
            ...
            <span class="anticon-class">
              <span class="ant-badge">folder-open
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-folder-add">
              <svg
                viewBox="64 64 896 896"
            ...
            <span class="anticon-class">
              <span class="ant-badge">folder-add
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-hdd">
              <svg
                viewBox="64 64 896 896"
                data-icon="hdd"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">hdd
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-frown">
              <svg
                viewBox="64 64 896 896"
                data-icon="frown"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">frown
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-meh">
              <svg
                viewBox="64 64 896 896"
                data-icon="meh"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">meh
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-smile">
              <svg
                viewBox="64 64 896 896"
                data-icon="smile"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">smile
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-inbox">
              <svg
                viewBox="0 0 1024 1024"
                data-icon="inbox"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">inbox
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-laptop">
              <svg
                viewBox="64 64 896 896"
                data-icon="laptop"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">laptop
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-appstore">
              <svg
                viewBox="64 64 896 896"
                data-icon="appstore"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">appstore
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-link">
              <svg
                viewBox="64 64 896 896"
                data-icon="link"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-mail">
              <svg
                viewBox="64 64 896 896"
                data-icon="mail"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">mail
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-mobile">
              <svg
                viewBox="64 64 896 896"
                data-icon="mobile"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">mobile
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-notification">
              <svg
                viewBox="64 64 896 896"
            ...
            <span class="anticon-class">
              <span class="ant-badge">notification
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-paper-clip">
              <svg
                viewBox="64 64 896 896"
            ...
            <span class="anticon-class">
              <span class="ant-badge">paper-clip
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-picture">
              <svg
                viewBox="64 64 896 896"
                data-icon="picture"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">picture
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-poweroff">
              <svg
                viewBox="64 64 896 896"
                data-icon="poweroff"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">poweroff
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-reload">
              <svg
                viewBox="64 64 896 896"
                data-icon="reload"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">reload
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-search">
              <svg
                viewBox="64 64 896 896"
                data-icon="search"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">search
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-setting">
              <svg
                viewBox="64 64 896 896"
                data-icon="setting"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">setting
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-share-alt">
              <svg
                viewBox="64 64 896 896"
                data-icon="share-alt"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">share-alt
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-shopping-cart">
              <svg
                viewBox="0 0 1024 1024"
            ...
            <span class="anticon-class">
              <span class="ant-badge">shopping-cart
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-tablet">
              <svg
                viewBox="64 64 896 896"
                data-icon="tablet"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">tablet
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-tag">
              <svg
                viewBox="64 64 896 896"
                data-icon="tag"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">tag
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-tags">
              <svg
                viewBox="64 64 896 896"
                data-icon="tags"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">tags
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-to-top">
              <svg
                viewBox="64 64 896 896"
                data-icon="to-top"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">to-top
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-upload">
              <svg
                viewBox="64 64 896 896"
                data-icon="upload"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">upload
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-user">
              <svg
                viewBox="64 64 896 896"
                data-icon="user"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">user
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-video-camera">
              <svg
                viewBox="64 64 896 896"
            ...
            <span class="anticon-class">
              <span class="ant-badge">video-camera
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-home">
              <svg
                viewBox="64 64 896 896"
                data-icon="home"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">home
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-loading">
              <svg
                viewBox="0 0 1024 1024"
                data-icon="loading"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">loading
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-loading-3-quarters">
              <svg
                viewBox="0 0 1024 1024"
            ...
            <span class="anticon-class">
              <span class="ant-badge">loading-3-quarters
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-cloud-upload">
              <svg
                viewBox="64 64 896 896"
            ...
            <span class="anticon-class">
              <span class="ant-badge">cloud-upload
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-star">
              <svg
                viewBox="64 64 896 896"
                data-icon="star"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">star
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-heart">
              <svg
                viewBox="64 64 896 896"
                data-icon="heart"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">heart
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-environment">
              <svg
                viewBox="64 64 896 896"
            ...
            <span class="anticon-class">
              <span class="ant-badge">environment
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-eye">
              <svg
                viewBox="64 64 896 896"
                data-icon="eye"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">eye
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-camera">
              <svg
                viewBox="64 64 896 896"
                data-icon="camera"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">camera
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-save">
              <svg
                viewBox="64 64 896 896"
                data-icon="save"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">save
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-team">
              <svg
                viewBox="64 64 896 896"
                data-icon="team"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">team
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-solution">
              <svg
                viewBox="64 64 896 896"
                data-icon="solution"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">solution
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-phone">
              <svg
                viewBox="64 64 896 896"
                data-icon="phone"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">phone
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-filter">
              <svg
                viewBox="64 64 896 896"
                data-icon="filter"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">filter
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-exception">
              <svg
                viewBox="64 64 896 896"
                data-icon="exception"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">exception
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-export">
              <svg
                viewBox="64 64 896 896"
                data-icon="export"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">export
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-customer-service">
              <svg
                viewBox="64 64 896 896"
            ...
            <span class="anticon-class">
              <span class="ant-badge">customer-service
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-qrcode">
              <svg
                viewBox="64 64 896 896"
                data-icon="qrcode"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">qrcode
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-scan">
              <svg
                viewBox="64 64 896 896"
                data-icon="scan"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">scan
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-like">
              <svg
                viewBox="64 64 896 896"
                data-icon="like"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">like
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-dislike">
              <svg
                viewBox="64 64 896 896"
                data-icon="dislike"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">dislike
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-message">
              <svg
                viewBox="64 64 896 896"
                data-icon="message"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">message
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-pay-circle">
              <svg
                viewBox="64 64 896 896"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-calculator">
              <svg
                viewBox="64 64 896 896"
            ...
            <span class="anticon-class">
              <span class="ant-badge">calculator
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-pushpin">
              <svg
                viewBox="64 64 896 896"
                data-icon="pushpin"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">pushpin
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-bulb">
              <svg
                viewBox="64 64 896 896"
                data-icon="bulb"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">bulb
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-select">
              <svg
                viewBox="64 64 896 896"
                data-icon="select"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">select
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-switcher">
              <svg
                viewBox="64 64 896 896"
                data-icon="switcher"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">switcher
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-rocket">
              <svg
                viewBox="64 64 896 896"
                data-icon="rocket"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">rocket
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-bell">
              <svg
                viewBox="64 64 896 896"
                data-icon="bell"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">bell
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-disconnect">
              <svg
                viewBox="64 64 896 896"
            ...
            <span class="anticon-class">
              <span class="ant-badge">disconnect
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-database">
              <svg
                viewBox="64 64 896 896"
                data-icon="database"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">database
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-compass">
              <svg
                viewBox="64 64 896 896"
                data-icon="compass"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">compass
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-barcode">
              <svg
                viewBox="64 64 896 896"
                data-icon="barcode"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">barcode
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-hourglass">
              <svg
                viewBox="64 64 896 896"
                data-icon="hourglass"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">hourglass
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-key">
              <svg
                viewBox="64 64 896 896"
                data-icon="key"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">key
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-flag">
              <svg
                viewBox="64 64 896 896"
                data-icon="flag"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">flag
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-layout">
              <svg
                viewBox="64 64 896 896"
                data-icon="layout"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">layout
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-printer">
              <svg
                viewBox="64 64 896 896"
                data-icon="printer"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">printer
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-sound">
              <svg
                viewBox="64 64 896 896"
                data-icon="sound"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">sound
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-usb">
              <svg
                viewBox="64 64 896 896"
                data-icon="usb"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">usb
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-skin">
              <svg
                viewBox="64 64 896 896"
                data-icon="skin"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">skin
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-tool">
              <svg
                viewBox="64 64 896 896"
                data-icon="tool"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">tool
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-sync">
              <svg
                viewBox="64 64 896 896"
                data-icon="sync"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">sync
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-wifi">
              <svg
                viewBox="64 64 896 896"
                data-icon="wifi"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">wifi
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-car">
              <svg
                viewBox="64 64 896 896"
                data-icon="car"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">car
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-schedule">
              <svg
                viewBox="64 64 896 896"
                data-icon="schedule"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">schedule
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-user-add">
              <svg
                viewBox="64 64 896 896"
                data-icon="user-add"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-user-delete">
              <svg
                viewBox="64 64 896 896"
            ...
            <span class="anticon-class">
              <span class="ant-badge">user-delete
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-usergroup-add">
              <svg
                viewBox="64 64 896 896"
            ...
            <span class="anticon-class">
              <span class="ant-badge">usergroup-add
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-usergroup-delete">
              <svg
                viewBox="64 64 896 896"
            ...
            <span class="anticon-class">
              <span class="ant-badge">usergroup-delete
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-man">
              <svg
                viewBox="64 64 896 896"
                data-icon="man"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-woman">
              <svg
                viewBox="64 64 896 896"
                data-icon="woman"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">woman
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-shop">
              <svg
                viewBox="64 64 896 896"
                data-icon="shop"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">shop
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-gift">
              <svg
                viewBox="64 64 896 896"
                data-icon="gift"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">gift
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-idcard">
              <svg
                viewBox="64 64 896 896"
                data-icon="idcard"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">idcard
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-medicine-box">
              <svg
                viewBox="64 64 896 896"
            ...
            <span class="anticon-class">
              <span class="ant-badge">medicine-box
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-red-envelope">
              <svg
                viewBox="64 64 896 896"
            ...
            <span class="anticon-class">
              <span class="ant-badge">red-envelope
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-coffee">
              <svg
                viewBox="0 0 1024 1024"
                data-icon="coffee"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">coffee
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-copyright">
              <svg
                viewBox="64 64 896 896"
                data-icon="copyright"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">copyright
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-trademark">
              <svg
                viewBox="64 64 896 896"
                data-icon="trademark"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">trademark
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-safety">
              <svg
                viewBox="0 0 1024 1024"
                data-icon="safety"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">safety
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-wallet">
              <svg
                viewBox="64 64 896 896"
                data-icon="wallet"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">wallet
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-bank">
              <svg
                viewBox="64 64 896 896"
                data-icon="bank"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">bank
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-trophy">
              <svg
                viewBox="64 64 896 896"
                data-icon="trophy"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">trophy
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-contacts">
              <svg
                viewBox="64 64 896 896"
                data-icon="contacts"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">contacts
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-global">
              <svg
                viewBox="64 64 896 896"
                data-icon="global"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">global
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-shake">
              <svg
                viewBox="64 64 896 896"
                data-icon="shake"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-api">
              <svg
                viewBox="64 64 896 896"
                data-icon="api"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-fork">
              <svg
                viewBox="64 64 896 896"
                data-icon="fork"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">fork
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-dashboard">
              <svg
                viewBox="64 64 896 896"
                data-icon="dashboard"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">dashboard
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-table">
              <svg
                viewBox="64 64 896 896"
                data-icon="table"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-profile">
              <svg
                viewBox="64 64 896 896"
                data-icon="profile"
                width="1em"
            ...
            <span class="anticon-class">
              <span class="ant-badge">profile
                <!---->
              </span>
            </span>
          </li>
          <li class>
            <i @click="onsomething" class="anticon anticon-alert">
              <svg
                viewBox="64 64 896 896"
                data-icon="alert"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-audit">
              <svg
                viewBox="64 64 896 896"
                data-icon="audit"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-branches">
              <svg
                viewBox="64 64 896 896"
                data-icon="branches"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-build">
              <svg
                viewBox="64 64 896 896"
                data-icon="build"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-border">
              <svg
                viewBox="64 64 896 896"
                data-icon="border"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-crown">
              <svg
                viewBox="64 64 896 896"
                data-icon="crown"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-experiment">
              <svg
                viewBox="64 64 896 896"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-fire">
              <svg
                viewBox="64 64 896 896"
                data-icon="fire"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-money-collect">
              <svg
                viewBox="64 64 896 896"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-property-safety">
              <svg
                viewBox="64 64 896 896"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-read">
              <svg
                viewBox="64 64 896 896"
                data-icon="read"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-reconciliation">
              <svg
                viewBox="64 64 896 896"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-rest">
              <svg
                viewBox="64 64 896 896"
                data-icon="rest"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-security-scan">
              <svg
                viewBox="64 64 896 896"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-insurance">
              <svg
                viewBox="64 64 896 896"
                data-icon="insurance"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-interation">
              <svg
                viewBox="64 64 896 896"
                data-icon="interation"
                width="1em"
                height="1em"
                fill="currentColor"
                aria-hidden="true"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-safety-certificate">
              <svg
                viewBox="64 64 896 896"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-project">
              <svg
                viewBox="64 64 896 896"
                data-icon="project"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-thunderbolt">
              <svg
                viewBox="64 64 896 896"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-block">
              <svg
                viewBox="64 64 896 896"
                data-icon="block"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-cluster">
              <svg
                viewBox="64 64 896 896"
                data-icon="cluster"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-deployment-unit">
              <svg
                viewBox="64 64 896 896"
                data-icon="deployment-unit"
                width="1em"
                height="1em"
                fill="currentColor"
                aria-hidden="true"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-dollar">
              <svg
                viewBox="64 64 896 896"
                data-icon="dollar"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-euro">
              <svg
                viewBox="64 64 896 896"
                data-icon="euro"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-pound">
              <svg
                viewBox="64 64 896 896"
                data-icon="pound"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-file-done">
              <svg
                viewBox="64 64 896 896"
                data-icon="file-done"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-file-exclamation">
              <svg
                viewBox="64 64 896 896"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-file-protect">
              <svg
                viewBox="64 64 896 896"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-file-search">
              <svg
                viewBox="64 64 896 896"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-file-sync">
              <svg
                viewBox="64 64 896 896"
                data-icon="file-sync"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-gateway">
              <svg
                viewBox="64 64 896 896"
                data-icon="gateway"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-gold">
              <svg
                viewBox="64 64 896 896"
                data-icon="gold"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-robot">
              <svg
                viewBox="64 64 896 896"
                data-icon="robot"
                width="1em"
          ...
          <li class>
            <i @click="onsomething" class="anticon anticon-shopping">
              <svg
                viewBox="64 64 896 896"
                data-icon="shopping"
                width="1em"
